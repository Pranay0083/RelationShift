...
CREATE TABLE "Subsctiption" (
    ...
    CONSTRAINT "Subsctiption_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Subsctiption_userId_key" ON "Subsctiption"("userId");
...
-- AddForeignKey
ALTER TABLE "Subsctiption" ADD CONSTRAINT "Subsctiption_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
